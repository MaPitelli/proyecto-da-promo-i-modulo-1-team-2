tarea5 = {
    ...
    "Para hacer el DNI debes acudir a… ": [
    ...
    "El carné de conducir se hace en… ": [
    ...
    "Las viviendas de protección oficial… ": [
        "a) tienen un precio limitado",
        "b) son para los funcionarios",
        "c) tienen sistema de vigilancia",
        "a"
    ],
    ...
    "¿Con cuántos hijos una familia es numerosa? ": [
        "a) Con 1 hijo",
        "b) Con 2 hijos",
        "c) Con 3 hijos",
        "c"
    ],
    "En España está permitido el matrimonio… ": [
        "a) solo entre personas del mismo sexo",
        "b) entre personas del mismo y diferente sexo",
        "c) solo entre personas de diferente sexo",
        "b"
    ],
    "Los propietarios de perros deben registrarlos en… ": [
    ...
    "En una comunidad de vecinos, una de las normas es… ": [
    ...
    "La Fiesta Nacional de España es el… ": [
        "a) 6 de diciembre",
        "b) 15 de agosto",
        "c) 12 de octubre",
        "c"
    ...
    "¿Cuál es el horario habitual de los hipermercados y centros comerciales? ": [
        "a) De 9:00 a 17:00 h",
        "b) De 10:00 a 22:00 h",
        "c) De 8:00 a 23:00 h",
        "b"
    ],
    "¿Dónde se hace el pasaporte? ": [
        "a) En el registro civil",
    ...
    "Los colegios públicos… ": [
        ...
        "b) pueden contratar los profesores que quieran",
        "c) son gratuitos",
        " 8",
        "c"
    ],
    ...
    "Un colegio concertado es un colegio privado que… ": [
    ...
    "Las bibliotecas públicas son gratuitas para… ": [
        "a) todos",
        "b) los parados",
        "c) los niños",
        "a"
    ...
    "¿A qué hora se cena normalmente en España? ": [
        "a) A las 18 h",
        "b) A las 20 h",
        "c) A las 21 o 22 h",
        " 8",
    ...
    "¿Cuál es un periódico deportivo? ": [
        "a) ABC",
        "b) As",
        "c) Cinco días",
        "b"
    ],
    "¿Dónde se venden sellos y tabaco? ": [
        "a) En el quiosco",
        "b) En la farmacia",
        "c) En el estanco",
        "c"
    ...
    "¿Dónde se compran las medicinas con receta? ": [
        "a) En el hospital",
        "b) En el centro de salud",
        "c) En la farmacia",
        "c"
    ...
    "El aeropuerto Adolfo Suárez está en… ": [
        "a) Barcelona",
        "b) Madrid",
        "c) Bilbao",
        "b"
    ...
    "¿En qué caso se retira el permiso de conducir? ": [
        "a) Por accidente grave",
        "b) Por la pérdida de los puntos",
        "c) Por exceso de velocidad",
        "b"
    ],
    "¿Qué significa Renfe? ": [
        "a) Red Nacional de Fondos Europeos",
        "b) Red Nacional de los Ferrocarriles Españoles",
        "c) Red Nacional de Fundaciones Estatales",
        " 9",
        "b"
    ],
    "Los españoles necesitan el pasaporte para viajar a… ": [
        "a) Italia",
        "b) China",
        "c) Alemania",
        "b"
    ...
    "España es innovadora en el sector de… ": [
    ...
    "¿Cuándo empieza el calendario escolar? ": [
        "a) En agosto",
        "b) En septiembre",
        "c) En octubre",
        "b"
    ...
    "¿Qué impuesto pagan los residentes en España en función de la renta o el dinero ganado (salario, ingresos como autónomos, etc.)? ": [
        "a) IRPF (Impuesto sobre la Renta de las Personas Físicas)",
        "b) IVA (Impuesto sobre el Valor Añadido)",
        "c) IS (Impuesto sobre Sociedades)",
        "a"
    ],
